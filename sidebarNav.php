<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Add Meal Plans</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-listMealPlans.php">
              <i class="align-middle" data-feather="map"></i> <span class="align-middle">List Meal Plans</span>
            </a>
					</li>
