...
?>
			...
			<main class="content">
				<div class="container-fluid p-4">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Subscriptions</h1>
					</div>
					<hr>
				<div class="container table-responsive">
					...
					<tbody>
						...
						<td scope="col" > <?php  echo $row['15Days']; ?></td>
						<td scope="col" > <?php  echo $row['weekly']; ?></td>
						<td scope="col" > <?php  echo $row['monthly']; ?></td>
						<td scope="col">

							<a href="<?php echo SITE_PATH.'admin/'?>addSubscription/<?php echo $row['id']; ?>"> <button class="btn btn-success btn-sm">Edit</button> </a>
...
if( isset($_GET['type']) && $_GET['type']!==' '  &&  isset($_GET['id']) && $_GET['id'] > 0  )
{
	...
	if( $type == 'delete')
	{
		 mysqli_query($con,"delete from subscriptions where id='$id' ");
		 redirect(SITE_PATH.'admin/listSubscription');
