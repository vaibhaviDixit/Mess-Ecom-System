...
$sql="select * from dailycate order by id desc";
...
?>
			...
			<main class="content">
				<div class="container-fluid p-4">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Daily Categories</h1>
					</div>
					<hr>
				<div class="container table-responsive">
					...
					<tbody>
						...
						<td scope="col">
							...
							<a href="pages-addProCate.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-success btn-sm">Edit</button> </a>
...
if( isset($_GET['type']) && $_GET['type']!==' '  &&  isset($_GET['id']) && $_GET['id'] > 0  )
{
	...
	if( $type == 'delete')
	{
		 mysqli_query($con,"delete from dailycate where id='$id' ");
		 redirect(SITE_PATH.'admin/listProCate');
	...
	if( $type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update dailycate set status='$status' where id='$id' ");
		redirect(SITE_PATH.'admin/listProCate');
